...
from morl_baselines.multi_policy.gcn.gcn import BaseGCNModel, ContinuousActionsGeneralModel, DiscreteActionsGeneralModel

from morl_baselines.multi_policy.gcn.pareto import pareto_l2
from morl_baselines.multi_policy.gcn.lorenz import lorenz_l2
...
class GCNTNDPModel(BaseGCNModel):
    """GCNTNDP Model based on BaseGCNModel."""
...
class GCNTNDP(MOAgent, MOPolicy):
    """Generalized Conditioned Networks (GCN)."""
    ...
    def _choose_commands(self, num_episodes: int):
        ...
        #### New
        nd_i, _ = self.dominance_func( returns )
        ####
